...
<body>
  <div class="container">
    ...
    <div id="map"
     style="position:relative; overflow:hidden; 
            width:100%; height:500px; border-radius:12px;"></div> 
      ...
      <section class="history-section" aria-labelledby="historyTitle">
        ...
        <button id="btnRefreshHistory" class="refresh-btn" aria-label="새로고침">↻</button>
        </div>
 ...
 <!-- 네이버 지도 API (발급받은 Client ID 사용) -->
<script type="text/javascript" src="https://oapi.map.naver.com/openapi/v3/maps.js?ncpKeyId=azilk7tpsg"></script>
