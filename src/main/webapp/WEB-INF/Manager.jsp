...
<body>
  ...
  <header class="header">
    ...
    <div class="actions" aria-label="사용자 메뉴">
      <a href="Manager.do"><button class="admin-btn active" type="button" aria-current="page">관리자 메뉴</button></a>
      <a href="logout.do"><button class="login-btn" type="button" data-action="logout">로그아웃</button></a>
    </div>
  </header>
    ...
    <div class="modal" id="userModal">
      <div class="modal-content">
        ...
        <form action="Join.do" method="post">
          <label>아이디 <input type="text" name="newId" required /></label>
          <label>비밀번호 <input type="password" name="newPw" required /></label>
          <label>지역 <input type="text" name="newArea" required /></label>
          <div class="modal-actions">
            <button class="btn primary" type="submit">등록</button>
            <button class="btn" type="button" id="cancelUser">취소</button>
          </div>
        </form>
      </div>
    </div>
      ...
      <div class="modal-content">
        ...
        <form action="Update.do" method="post">
          ...
          <div class="modal-actions">
            ...
            <button class="btn" type="button" id="cancelUpdate">취소</button>
          </div>
        </form>
      </div>
    </div>
